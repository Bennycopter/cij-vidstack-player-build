import { createContext, useContext, prop, Component, computed, provideContext, signal, isBoolean, effect, setAttribute, uppercaseFirstChar, isNil, isString, noop, isFunction, unwrap, camelToKebabCase, onDispose, scoped, keysOf, isArray, tick, peek, isKeyboardClick } from './vidstack-BGSTndAW.js';
import { useMediaContext, useMediaState } from './vidstack-DJDnh4xT.js';
import { watchColorScheme, $ariaBool, useResizeObserver, useActive } from './vidstack-C2US-gSO.js';
import { html } from 'lit-html';
import { $signal, LayoutIconsLoader, Icon } from './vidstack-Dq5Yu0Vr.js';
import { watchActiveTextTrack } from './vidstack-DYbwIVLq.js';
import { sortVideoQualities } from './vidstack-BTM4ERc7.js';
import { ifDefined } from 'lit-html/directives/if-defined.js';
import { ref } from 'lit-html/directives/ref.js';
import { getDownloadFile, appendParamsToURL } from './vidstack-CTojmhKq.js';
...
class DefaultLayoutIconsLoader extends LayoutIconsLoader {
  async loadIcons() {
    const paths = (await import('./vidstack-BTigPj2h.js')).icons, icons = {};
