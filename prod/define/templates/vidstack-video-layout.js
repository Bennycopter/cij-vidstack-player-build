import { computed, signal, effect, camelToKebabCase, Host } from '../../chunks/vidstack-BGSTndAW.js';
import { DefaultLayout, useDefaultLayoutContext, DefaultPlayButton, DefaultAnnouncer, DefaultCaptions, DefaultAirPlayButton, DefaultGoogleCastButton, DefaultControlsSpacer, DefaultCaptionButton, DefaultDownloadButton, DefaultVolumePopup, DefaultTimeInfo, DefaultTitle, DefaultFullscreenButton, DefaultTimeSlider, DefaultPIPButton, DefaultChaptersMenu, DefaultSettingsMenu, setLayoutName, createMenuContainer, DefaultLayoutIconsLoader } from '../../chunks/vidstack-C5Ejk6oB.js';
import { useMediaContext, useMediaState } from '../../chunks/vidstack-DJDnh4xT.js';
import { $signal, SlotManager } from '../../chunks/vidstack-Dq5Yu0Vr.js';
import { LitElement } from '../../chunks/vidstack-CwTj4H1w.js';
import { html } from 'lit-html';
import { keyed } from 'lit-html/directives/keyed.js';
import { createSlot } from '../../chunks/vidstack-C2US-gSO.js';
...
function DefaultVideoLayoutLarge() {
  return [
    ...
    html`
      ...
      // Region [CIJ] Always show center play button on touch devices
      html`<media-controls-group class="vds-controls-group" style="pointer-events: none; position: relative; top: 22px;">
            ${[
        DefaultControlsSpacer(),
        DefaultPlayButton({ tooltip: "top", classes: "cij-center-of-player" }),
        DefaultControlsSpacer()
      ]}
      ...
      html`
            <media-controls-group class="vds-controls-group">
              ${[
        DefaultPlayButton({ tooltip: "top start", classes: "cij-bottom-of-player" }),
