import { Host, effect, Component, signal, setAttribute, isBoolean, computed, isString, useState } from './vidstack-Bu2kfzUd.js';
import { Captions, Gesture, MediaAnnouncer, Controls, ControlsGroup, GoogleCastButton, ToggleButton, Tooltip, TooltipTrigger, TooltipContent, ChaptersRadioGroup, AudioGainRadioGroup, RadioGroup, SliderVideo, AudioGainSlider, SpeedSlider, QualitySlider, SliderChapters } from './vidstack-CRIEJoSr.js';
import { useMediaContext } from './vidstack-DFImIcIL.js';
import { watchCueTextChange } from './vidstack-28cU2iGK.js';
import { html } from 'lit-html';
import { requestScopedAnimationFrame, isHTMLElement, cloneTemplateContent, createTemplate, cloneTemplate } from './vidstack-C_l97D5j.js';
import { LitElement } from './vidstack-CwTj4H1w.js';
import { MenuPortal, Slider, sliderState } from './vidstack-DeuJ73e8.js';
import { renderMenuItemsTemplate } from './vidstack-DA8WuGxt.js';
