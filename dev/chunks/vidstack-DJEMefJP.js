import { createContext, useContext, prop, Component, computed, provideContext, signal, isBoolean, effect, setAttribute, uppercaseFirstChar, isNil, isString, noop, isFunction, unwrap, camelToKebabCase, onDispose, scoped, keysOf, isArray, tick, peek, isKeyboardClick } from './vidstack-Bu2kfzUd.js';
import { useMediaContext, useMediaState } from './vidstack-DFImIcIL.js';
import { watchColorScheme, $ariaBool, useResizeObserver, useActive } from './vidstack-C_l97D5j.js';
import { html } from 'lit-html';
import { $signal, LayoutIconsLoader, Icon } from './vidstack-Bcmx8pmK.js';
...
import { getDownloadFile, appendParamsToURL } from './vidstack-zG6PIeGg.js';
...
class DefaultLayoutIconsLoader extends LayoutIconsLoader {
  async loadIcons() {
    const paths = (await import('./vidstack-CFNlaVTR.js')).icons, icons = {};
